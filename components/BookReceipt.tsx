    ...
    <>
      {btnVariant === "user" ? (
        ...
        <button
          type="button"
          onClick={handleDownload}
          className="flex size-8 items-center justify-center rounded-md bg-white"
        >
          <Image
      ...
      <section id="book-ticket">
        <div className="flex items-center gap-2 px-8">
          <Image
            ...
            className="object-contain"
          />
          <p className="text-2xl font-semibold text-white">Learnables</p>
        </div>
